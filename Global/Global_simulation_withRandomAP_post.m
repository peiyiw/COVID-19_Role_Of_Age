...
Vac = readtable('vaccination.xlsx');
...
for i=1:length(Country)
	...
	for j=1:N
		...
		[scale_factor,R0_actual] = target_R0(pop_stru_size,suscep,asym_prob,contact_matrix,beta,k,r,sigma,sigma_pre,gamma_a,gamma_s,R0);
		scale_factor
		[Asym,Sym,NextAsym,NextSym] = ODEsimulation_post(pop_stru_size,suscep,asym_prob,contact_matrix,scale_factor,k,r,sigma,sigma_pre,gamma_a,gamma_s,vac_proportion);
